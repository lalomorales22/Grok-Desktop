...
function HandsPage() {
  ...
  const capabilities = [
    "Chat with Grok from your phone",
    "Generate images, video, and audio remotely",
    "Keep working against your local workspace and media library",
    "Operate the machine through the same shell and agent surface Grok Desktop has locally",
  ];
            ...
            <div className="grid gap-4 p-5 xl:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.65fr)]">
              <div>
                ...
                <h2 className="mt-3 max-w-3xl text-[27px] font-semibold leading-tight text-stone-100">
                  Your off-site operator page for Grok Desktop.
                </h2>
                <p className="mt-3 max-w-3xl text-[12px] leading-6 text-stone-300">
                  Hands is the remote agent surface. When you leave the machine, this page keeps Grok Desktop reachable
              ...
              <div className="mt-4 space-y-3 text-[11px] leading-6 text-stone-300">
                ...
                <div className="rounded-[20px] border border-white/8 bg-black/20 p-3">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    {["Chat", "Imagine", "Voice & Audio", "Media", "Workspace", "Shell", "Files"].map((surface) => (
                      <span
                        key={surface}
              ...
              <div className="mt-4 space-y-2">
                {messageItems.length ? (
                  ...
                  <EmptyPanel
                    ...
                    body="Once a phone pairs, this feed will show mobile prompts, Grok replies, tunnel events, and remote work traces."
                  />
                )}
              </div>
            </div>
