...
`hands-relay` is the public relay/control-plane for the Grok Desktop `Hands` provider.
...
This repository includes a root-level [`render.yaml`](/Users/megabrain2/Software/Rust-Apps/Grok-Desktop/render.yaml) Blueprint for `hands-relay`.
